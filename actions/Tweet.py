...
class Tweet(object):
    def __init__(self):
        ...
        self.driver = webdriver.Chrome(executable_path="/Users/anubhav.gupta/Downloads/chromedriver")
...
# print obj.content
# print obj.hashtag
obj.word_count('p[class="TweetTextSize TweetTextSize--normal js-tweet-text tweet-text"]')
